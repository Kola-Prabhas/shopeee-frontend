...
export default function Cart() {
	...
	return (
		<div className="mx-auto max-w-5xl p-4 sm:p-6 lg:px-8 bg-[#f9f9f9]">
			...
			{items.length === 0 && <h3 className="mt-20 text-xl font-semibold tracking-tight text-indigo-500 text-center">Your cart is empty. Add items to cart to view them here</h3>}
	    </div>
  );
}
